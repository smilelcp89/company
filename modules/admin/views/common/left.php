...
<body style="background:#f0f9fd;">
	...
	<dd><div class="title"><span><img src="<?=Yii::$app->params['imgHost'];?>backend/images/leftico01.png" /></span>新闻分类管理</div>
		<ul class="menuson">
			<li><cite></cite><a href="/admin/news-category/index" target="rightFrame">新闻分类列表</a><i></i></li>
			<li><cite></cite><a href="/admin/news-category/create" target="rightFrame">添加新闻分类</a><i></i></li>
		</ul>
	</dd>
    ...
    <dd><div class="title"><span><img src="<?=Yii::$app->params['imgHost'];?>backend/images/leftico01.png" /></span>广告管理</div>
    <ul class="menuson">
        <li><cite></cite><a href="/admin/ad/index" target="rightFrame">广告列表</a><i></i></li>
        <li><cite></cite><a href="/admin/ad/create" target="rightFrame">添加广告</a><i></i></li>
    </ul>
    </dd>
