...
<body>
    ...
    <li><img src="<?=Yii::$app->params['imgHost'];?>backend/images/ico01.png" /><p><a href="#">管理设置</a></p></li>
    <li><img src="<?=Yii::$app->params['imgHost'];?>backend/images/ico02.png" /><p><a href="#">发布文章</a></p></li>
    <li><img src="<?=Yii::$app->params['imgHost'];?>backend/images/ico03.png" /><p><a href="#">数据统计</a></p></li>
    <li><img src="<?=Yii::$app->params['imgHost'];?>backend/images/ico04.png" /><p><a href="#">文件上传</a></p></li>
    <li><img src="<?=Yii::$app->params['imgHost'];?>backend/images/ico05.png" /><p><a href="#">目录管理</a></p></li>
    <li><img src="<?=Yii::$app->params['imgHost'];?>backend/images/ico06.png" /><p><a href="#">查询</a></p></li> 
            
    </ul>
    
    <div class="ibox"><a class="ibtn"><img src="<?=Yii::$app->params['imgHost'];?>backend/images/iadd.png" />添加新的快捷功能</a></div>
