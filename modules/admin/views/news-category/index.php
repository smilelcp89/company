...
$(function(){
	$(".delete").click(function(){
		...
		updateByIds('/admin/news-category/delete',{ids: data.join(","),status: status},'确定要删除已选择的项吗');
    });
	...
	<div class="place">
        ...
        <ul class="placeul">
            ...
            <li><a href="/admin/news-category">新闻分类管理</a></li>
	...
	<form>
    <ul class="seachform">
        <li><label>新闻分类名：</label><input name="title" value="<?=$params['title']?>" type="text" class="scinput" /></li>
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <td>
                <a href="<?=\yii\helpers\Url::to(['news-category/edit?id='.$row['id']])?>" class="tablelink">编辑</a>
				<a href="javascript:;" class="tablelink" onclick="updateByIds('/admin/news-category/delete',{ids:<?=$row['id']?>},'确定删除【<?=$row['title'];?>】吗？')">　删除</a>
            </td>
        </tr>
        <?php endforeach;?>
        <?php else:?>
